...
module.exports = {
    showHelp:  showHelp, parseSentence: parseSentence
}
module.exports = {
    showAll:  showAll, showHelp:  showHelp, parseSentence:  parseSentence
}
module.exports = { 
    parseLanguage:  parseLanguage, showAll:  showAll, showHelp:  showHelp, parseSentence:  parseSentence };